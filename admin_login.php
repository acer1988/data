...
<?php include('includes/admin_login_process.php') ?>  
<div class="form-admin-body container">         
<div class="text-center">
  <?php echo $global_message; ?>
<img class="mb-4" src="assets/img/transparent-logo.png" alt="" width="100" height="100">
<h1 class="h3 mb-3 fw-normal text-white">Admin Sign In</h1>
</div>  
  <form action="" method="POST">
    ...
    <div>
    <button class="form-admin-button btn btn-primary w-100 py-2" id="user_login" name="user_login" type="submit">Sign in</button>
    <hr>
    <p><a class="form-admin-link" href="forgot.php">Forgot Password</a>
    <br><a class="form-admin-link" href="login.php">User login</a>
    <hr>
    </div>
    ...
    <p class="mt-5 mb-3 text-center">
      ...
      <br>
      <a class="form-admin-link" href="#">Privacy Policy</a> &nbsp; <a class="form-admin-link" href="#">Terms and Conditions</a>
    </p>
    </div>
  </form>
</div>  
